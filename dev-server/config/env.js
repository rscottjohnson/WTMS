...
function setProdEnv(app) {
  process.env.DB_URL = 'mongodb+srv://rscottjohnson:zC0y4ubshvyI@wtms.kg7pz.mongodb.net/wtms?retryWrites=true&w=majority'; // set a url for the database connection
